...
export const EstudianteLayout = () => {
  ...
  const navItems = [
    ...
    { path: '/estudiante/perfil', label: 'Mi Perfil', icon: 'user' },
    { path: '/estudiante/evaluar-docentes', label: 'Evaluar Docentes', icon: 'star' },
    { path: '/estudiante/explorar', label: 'Explorar', icon: 'search' }
  ];
