...
export const DocenteLayout = () => {
  ...
  const navItems = [
    ...
    { path: '/docente/perfil', label: 'Mi Perfil', icon: 'user' },
    { path: '/docente/evaluaciones', label: 'Mis Evaluaciones', icon: 'chart' },
    { path: '/docente/recomendaciones', label: 'Recomendaciones', icon: 'lightbulb' }
  ];
